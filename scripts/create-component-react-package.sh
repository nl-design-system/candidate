...
>>"${component_dir}/src/${component}.test.tsx"
>>"${component_dir}/src/${component}.tsx"
>>"${component_dir}/src/css.test.tsx"
>>"${component_dir}/src/css.tsx"
>>"${component_dir}/babel.config.cjs"
>>"${component_dir}/rollup.config.mjs"
>>"${component_dir}/tsconfig.build.json"
>>"${component_dir}/tsconfig.json"
>>"${component_dir}/vitest.config.js"
