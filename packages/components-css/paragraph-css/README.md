...
```html
<p class="nl-paragraph">Tekst van de alinea.</p>
```

Met de lead-variant:

```html
<p class="nl-paragraph nl-paragraph--lead"><b class="nl-paragraph__lead">Korte intro.</b> De rest van de alinea.</p>
```

Zonder CSS classes (bij gebruik van `html/paragraph.css`):

```html
<p>Tekst van de alinea.</p>
```
