...
export const PressedActive: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Een subtle Button die ingedrukt en actief is.',
      },
    },
    testResult: {
      date: '2025-12-23',
...
export const PressedHover: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Een subtle Button die ingedrukt en gehovered is.',
      },
    },
    testResult: {
      date: '2025-12-23',
...
export const PositivePressedActive: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Een subtle positive Button die ingedrukt en actief is.',
      },
    },
    testResult: {
      date: '2025-12-23',
...
export const PositivePressedHover: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Een subtle positive Button die ingedrukt en gehovered is.',
      },
    },
    testResult: {
      date: '2025-12-23',
...
export const NegativePressedActive: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Een subtle negative Button die ingedrukt en actief is.',
      },
    },
    testResult: {
      date: '2025-12-23',
...
export const NegativePressedHover: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Een subtle negative Button die ingedrukt en gehovered is.',
      },
    },
    testResult: {
      date: '2025-12-23',
