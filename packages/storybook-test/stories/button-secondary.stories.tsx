...
const { secondary, ...tokens } = allTokens.nl.button;
...
export const PressedActive: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Een secondary Button die ingedrukt en actief is.',
      },
    },
    testResult: {
      date: '2025-12-23',
...
export const PressedHover: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Een secondary Button die ingedrukt en gehovered is.',
      },
    },
    testResult: {
      date: '2025-12-23',
...
export const PositivePressedActive: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Een secondary positive Button die ingedrukt en actief is.',
      },
    },
    testResult: {
      date: '2025-12-23',
...
export const PositivePressedHover: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Een secondary positive Button die ingedrukt en gehovered is.',
      },
    },
    testResult: {
      date: '2025-12-23',
...
export const NegativePressedActive: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Een secondary negative Button die ingedrukt en actief is.',
      },
    },
    testResult: {
      date: '2025-12-23',
...
export const NegativePressedHover: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Een secondary negative Button die ingedrukt en gehovered is.',
      },
    },
    testResult: {
      date: '2025-12-23',
