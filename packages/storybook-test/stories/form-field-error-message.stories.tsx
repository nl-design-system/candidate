...
export const FormFieldErrorMessageCompact: Story = {
  name: 'Beknopte Form Field Error Message bestaande uit een enkele HTML-element p',
  render: () => {
    const INPUT_ID = 'FormFieldErrorMessageCompact';
    const ERROR_ID = `${INPUT_ID}-error`;
    return (
      <>
        <div>
