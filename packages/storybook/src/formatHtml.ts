/**
 * This is a clone of the formatHtml file found in the Rijkshuisstijl Community.
 * When that package is publically released by the Rijkshuisstijl Community, this file is no longer needed
 * @see {@link https://github.com/nl-design-system/rijkshuisstijl-community/blob/main/packages/internal-tooling/src/formatHtml/formatHtml.ts}
 */
