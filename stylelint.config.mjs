export default {
  ...
  rules: {
    ...
    'custom-property-pattern': '^_?(ams|rhc|denhaag|example|nl|nlds|utrecht|ma|basis|pra|voorbeeld)-[a-z0-9-]+$',
    ...
    'keyframes-name-pattern': '^(ams|rhc|denhaag|example|nl|nlds|utrecht|ma|basis|pra|voorbeeld)-[a-z0-9-]+$',
    'length-zero-no-unit': [
      true,
      {
    ...
    'scss/dollar-variable-pattern': '^(ams|rhc|denhaag|example|nl|nlds|utrecht|ma|basis|pra|voorbeeld)-[a-z0-9-]+$',
